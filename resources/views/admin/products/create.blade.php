@extends('layouts.app')
@section('title', 'Add New Tour — Admin')
...
<div class="page-header">
    <div class="container">
        ...
        <h1 class="section-title" style="color:white;">Add New Tour</h1>
    </div>
</div>
...
<div class="container">
    <div class="form-wrap">
        ...
        <div class="form-card">
            <div class="form-card-header">Tour Information</div>
                ...
                <form method="POST" action="{{ route('admin.products.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-input @error('title') is-invalid @enderror"
                               value="{{ old('title') }}" placeholder="e.g. Bosphorus Sunset Cruise" required>
                        @error('title')<div class="form-error">{{ $message }}</div>@enderror
                    </div>

                    <div class="form-group">
                        <label class="form-label">Description <span style="color:var(--red);">*</span></label>
                        <textarea name="description" rows="4" class="form-input @error('description') is-invalid @enderror"
                                  placeholder="Describe what's included in this tour..." required>{{ old('description') }}</textarea>
                    ...
                    <div class="price-row">
                        <div>
                            ...
                            <div class="price-input-wrap">
                                ...
                                <input type="number" name="price" class="form-input @error('price') is-invalid @enderror"
                                       value="{{ old('price') }}" min="0" step="0.01" placeholder="89.00" required>
                            </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="duration_days" class="form-input @error('duration_days') is-invalid @enderror"
                                   value="{{ old('duration_days') }}" min="1" placeholder="3" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" name="image" class="form-input @error('image') is-invalid @enderror"
                               value="{{ old('image') }}" placeholder="https://example.com/tour-photo.jpg">
                        <div class="form-hint">Paste a direct image link from the web.</div>
