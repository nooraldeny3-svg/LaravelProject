@extends('layouts.app')
@section('title', 'Add New City — Admin')
...
<div class="page-header">
    <div class="container">
        ...
        <h1 class="section-title" style="color:white;">Add New City</h1>
    </div>
</div>
...
<div class="container">
    <div class="form-wrap">
        ...
        <div class="form-card">
            <div class="form-card-header">City Information</div>
                ...
                <form method="POST" action="{{ route('admin.categories.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-input @error('name') is-invalid @enderror"
                               value="{{ old('name') }}" placeholder="e.g. Istanbul, Cappadocia" required>
                        @error('name')<div class="form-error">{{ $message }}</div>@enderror
                    </div>

                    <div class="form-group">
                        <label class="form-label">Description</label>
                        <textarea name="description" rows="3" class="form-input @error('description') is-invalid @enderror"
                                  placeholder="A short description of the city...">{{ old('description') }}</textarea>
                    ...
                    <div class="form-group" style="margin-bottom:2rem;">
                        ...
                        <input type="url" name="image" class="form-input @error('image') is-invalid @enderror"
                               value="{{ old('image') }}" placeholder="https://example.com/city-photo.jpg">
